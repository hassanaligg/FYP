...
import com.example.rescue1122.adapters.AlertAdapter;
...
public class CheckEmergencyAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_emergency_admin);
        ...
        alertAdapter=new AlertAdapter(getApplicationContext(),alertslist);
       ...
       // adapter=new AlertAdapter(options,context);
